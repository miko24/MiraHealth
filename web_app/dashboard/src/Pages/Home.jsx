    ...
    return (
        ...
        >
            <Sider collapsible collapsed={collapsed} onCollapse={(value) => setCollapsed(value)}>
                ...
                <Menu theme="dark" defaultSelectedKeys={['1']} mode="inline" items={items} onSelect={onSelectHandler}/>
            </Sider>
            <Layout>
                <Header
                    style={{
                ...
                {/*                       url={"http://34.159.120.168:9090/api/v1/query?query=bpm_metric{job=\"script\"}[100s]"}/>*/}
                {/*            </Col>*/}
                {/*            <Col span={1}></Col>*/}
                {/*            <Col span={4}>*/}
                {/*                <Card*/}
                ...
                {/*                       range={[30,50]}*/}
                {/*                       url={"http://34.159.120.168:9090/api/v1/query?query=Temp_metric{job=\"script\"}[100s]"}/>*/}
                {/*            </Col>*/}
                {/*            <Col span={1}></Col>*/}
                {/*            <Col span={4}>*/}
                {/*                <Card*/}
                ...
                {/*                       range={[80,180]}*/}
                {/*                       url={"http://34.159.120.168:9090/api/v1/query?query=Pressure_metric{job=\"script\"}[100s]"}/>*/}
                {/*            </Col>*/}
                {/*            <Col span={1}></Col>*/}
                {/*            <Col span={4}>*/}
                {/*                <Card*/}
